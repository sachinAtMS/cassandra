...
public class DatabaseDescriptor
{
    ...
    */
     ...
     * Safe to call from tool JVM where conf may be null.
     */
    public static String getSnapshotDirectory()
    {
        return conf != null ? conf.snapshot_directory : null;
    }
    ...
    {
        return conf != null && conf.snapshot_directory != null && !conf.snapshot_directory.isEmpty();
    }

    /**
     * Returns the configured rate limit for external snapshot copies in bytes per second.
     * Returns 0 if not configured (unlimited).
     */
    public static long getSnapshotCopyBytesPerSecond()
    {
        return conf != null ? conf.snapshot_copy_bytes_per_second : 0;
    }
