 ...
 * <p>This validator:</p>
 * <ol>
 *   <li>Fetches JSON Web Key Set (JWKS) from Microsoft's well-known endpoint</li>
 *   <li>Verifies the RS256 signature of the JWT using the matching public key</li>
 *   <li>Validates standard claims: issuer (iss), audience (aud), expiry (exp), not-before (nbf)</li>
 *   <li>Extracts user identity and group membership claims</li>
 * </ol>
 *
 * <p>Uses only JDK classes and Jackson (already a Cassandra dependency) — no external JWT libraries required.</p>
 */
