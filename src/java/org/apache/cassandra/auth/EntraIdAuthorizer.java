 ...
 * INSERT INTO system_auth.entra_group_roles (group_id, cassandra_role) VALUES ('group-oid-uuid', 'db_readers');
 * </pre>
 *
 * <p>When a user with that group authenticates, they inherit permissions from
 * the mapped Cassandra role(s) in addition to their own role's permissions.</p>
 *
...
public class EntraIdAuthorizer extends CassandraAuthorizer
{
     ...
     * This table maps Entra ID group Object IDs / app role names to Cassandra roles.
     *
     * Schema:
